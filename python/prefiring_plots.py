...
def main(file_path, out_dir):
    ...
    c_eta_rat_before_u = ROOT.TCanvas( 'c_eta_rat_before_u', 'c_eta_rat_before_u', 10, 10, 800, 600 )

    JetEta_low_bxm1_before_u = inFile.Get("demo/JetEta_lowpt_bxm1_before_unprefirable")
    JetEta_low_bx0_bxm1_before_u = inFile.Get("demo/JetEta_lowpt_bx0_bxm1_before_unprefirable")

    JetEta_low_ratio_before_u = JetEta_low_bxm1_before_u.Clone()

    JetEta_low_ratio_before_u.Sumw2()
    JetEta_low_bx0_bxm1_before_u.Sumw2()
    JetEta_low_ratio_before_u.Divide(JetEta_low_bx0_bxm1_before_u)

    JetEta_low_ratio_before_u.SetLineColor(50)
    JetEta_low_ratio_before_u.SetMarkerColor(50)
    JetEta_low_ratio_before_u.SetMarkerStyle(8)
    JetEta_low_ratio_before_u.SetMarkerSize(0.5)
    JetEta_low_ratio_before_u.SetTitle("Before HCAL Timing Correction - Unprefirable")
    JetEta_low_ratio_before_u.GetXaxis().SetTitle("Reco Jet #eta")
    JetEta_low_ratio_before_u.GetYaxis().SetTitle("(bx=-1)/(bx=-1 or bx=0)")
    JetEta_low_ratio_before_u.SetMinimum(0)
    JetEta_low_ratio_before_u.SetMaximum(0.25)
    JetEta_low_ratio_before_u.SetStats(False)
    JetEta_low_ratio_before_u.Draw("E")

    JetEta_med_bxm1_before_u = inFile.Get("demo/JetEta_medpt_bxm1_before_unprefirable")
    JetEta_med_bx0_bxm1_before_u = inFile.Get("demo/JetEta_medpt_bx0_bxm1_before_unprefirable")

    JetEta_med_ratio_before_u = JetEta_med_bxm1_before_u.Clone()

    JetEta_med_ratio_before_u.Sumw2()
    JetEta_med_bx0_bxm1_before_u.Sumw2()
    JetEta_med_ratio_before_u.Divide(JetEta_med_bx0_bxm1_before_u)

    JetEta_med_ratio_before_u.SetLineColor(54)
    JetEta_med_ratio_before_u.SetMarkerColor(54)
    JetEta_med_ratio_before_u.SetMarkerStyle(29)
    JetEta_med_ratio_before_u.SetMarkerSize(0.5)
    JetEta_med_ratio_before_u.SetStats(False);
    JetEta_med_ratio_before_u.Draw("E same")

    JetEta_high_bxm1_before_u = inFile.Get("demo/JetEta_high_bxm1_before_unprefirable")
    JetEta_high_bx0_bxm1_before_u = inFile.Get("demo/JetEta_high_bx0_bxm1_before_unprefirable")

    JetEta_high_ratio_before_u = JetEta_high_bxm1_before_u.Clone()

    JetEta_high_ratio_before_u.Sumw2()
    JetEta_high_bx0_bxm1_before_u.Sumw2()
    JetEta_high_ratio_before_u.Divide(JetEta_high_bx0_bxm1_before_u)

    JetEta_high_ratio_before_u.SetLineColor(108)
    JetEta_high_ratio_before_u.SetMarkerColor(108)
    JetEta_high_ratio_before_u.SetMarkerStyle(21)
    JetEta_high_ratio_before_u.SetMarkerSize(0.5)
    JetEta_high_ratio_before_u.SetStats(False);
    JetEta_high_ratio_before_u.Draw("E same")

    legend = ROOT.TLegend(0.3,0.75,0.6,0.88)
    legend.AddEntry(JetEta_low_ratio_before_u,"L1 p_T > 15 GeV","L")
    legend.AddEntry(JetEta_med_ratio_before_u,"L1 p_T > 40 GeV","L")
    legend.AddEntry(JetEta_high_ratio_before_u,"L1 p_T > 180 GeV","L")
    legend.SetBorderSize(0)
    legend.SetTextSize(0.04)
    legend.Draw()

    c_eta_rat_before_u.Draw()
    c_eta_rat_before_u.SaveAs(f"{out_dir}/jeteta_ratio_ptsep_before_unprefirable.png")
    c_eta_rat_before_u.Close() 
  
    c_eta_rat_after_u = ROOT.TCanvas( 'c_eta_rat_after_u', 'c_eta_rat_after_u', 10, 10, 800, 600 )

    JetEta_low_bxm1_after_u = inFile.Get("demo/JetEta_lowpt_bxm1_after_unprefirable")
    JetEta_low_bx0_bxm1_after_u = inFile.Get("demo/JetEta_lowpt_bx0_bxm1_after_unprefirable")

    JetEta_low_ratio_after_u = JetEta_low_bxm1_after_u.Clone()

    JetEta_low_ratio_after_u.Sumw2()
    JetEta_low_bx0_bxm1_after_u.Sumw2()
    JetEta_low_ratio_after_u.Divide(JetEta_low_bx0_bxm1_after_u)

    JetEta_low_ratio_after_u.SetLineColor(50)
    JetEta_low_ratio_after_u.SetMarkerColor(50)
    JetEta_low_ratio_after_u.SetMarkerStyle(8)
    JetEta_low_ratio_after_u.SetMarkerSize(0.5)
    JetEta_low_ratio_after_u.SetTitle("After HCAL Timing Correction - Unprefirable")
    JetEta_low_ratio_after_u.GetXaxis().SetTitle("Reco Jet #eta")
    JetEta_low_ratio_after_u.GetYaxis().SetTitle("(bx=-1)/(bx=-1 or bx=0)")
    JetEta_low_ratio_after_u.SetMinimum(0)
    JetEta_low_ratio_after_u.SetMaximum(0.25)
    JetEta_low_ratio_after_u.SetStats(False)
    JetEta_low_ratio_after_u.Draw("E")

    JetEta_med_bxm1_after_u = inFile.Get("demo/JetEta_medpt_bxm1_after_unprefirable")
    JetEta_med_bx0_bxm1_after_u = inFile.Get("demo/JetEta_medpt_bx0_bxm1_after_unprefirable")

    JetEta_med_ratio_after_u = JetEta_med_bxm1_after_u.Clone()

    JetEta_med_ratio_after_u.Sumw2()
    JetEta_med_bx0_bxm1_after_u.Sumw2()
    JetEta_med_ratio_after_u.Divide(JetEta_med_bx0_bxm1_after_u)

    JetEta_med_ratio_after_u.SetLineColor(54)
    JetEta_med_ratio_after_u.SetMarkerColor(54)
    JetEta_med_ratio_after_u.SetMarkerStyle(29)
    JetEta_med_ratio_after_u.SetMarkerSize(0.5)
    JetEta_med_ratio_after_u.SetStats(False);
    JetEta_med_ratio_after_u.Draw("E same")

    JetEta_high_bxm1_after_u = inFile.Get("demo/JetEta_high_bxm1_after_unprefirable")
    JetEta_high_bx0_bxm1_after_u = inFile.Get("demo/JetEta_high_bx0_bxm1_after_unprefirable")

    JetEta_high_ratio_after_u = JetEta_high_bxm1_after_u.Clone()

    JetEta_high_ratio_after_u.Sumw2()
    JetEta_high_bx0_bxm1_after_u.Sumw2()
    JetEta_high_ratio_after_u.Divide(JetEta_high_bx0_bxm1_after_u)

    JetEta_high_ratio_after_u.SetLineColor(108)
    JetEta_high_ratio_after_u.SetMarkerColor(108)
    JetEta_high_ratio_after_u.SetMarkerStyle(21)
    JetEta_high_ratio_after_u.SetMarkerSize(0.5)
    JetEta_high_ratio_after_u.SetStats(False);
    JetEta_high_ratio_after_u.Draw("E same")

    legend = ROOT.TLegend(0.3,0.75,0.6,0.88)
    legend.AddEntry(JetEta_low_ratio_after_u,"L1 p_T > 15 GeV","L")
    legend.AddEntry(JetEta_med_ratio_after_u,"L1 p_T > 40 GeV","L")
    legend.AddEntry(JetEta_high_ratio_after_u,"L1 p_T > 180 GeV","L")
    legend.SetBorderSize(0)
    legend.SetTextSize(0.04)
    legend.Draw()

    c_eta_rat_after_u.Draw()
    c_eta_rat_after_u.SaveAs(f"{out_dir}/jeteta_ratio_ptsep_after_unprefirable.png")
    c_eta_rat_after_u.Close()
 
    # FIRSTBUNCHINTRAIN RATIO SEPARATED PT
    c_eta_rat_before_f = ROOT.TCanvas( 'c_eta_rat_before_f', 'c_eta_rat_before_f', 10, 10, 800, 600 )

    JetEta_low_bxm1_before_f = inFile.Get("demo/JetEta_lowpt_bxm1_before_firstbunch")
    JetEta_low_bx0_bxm1_before_f = inFile.Get("demo/JetEta_lowpt_bx0_bxm1_before_firstbunch")

    JetEta_low_ratio_before_f = JetEta_low_bxm1_before_f.Clone()

    JetEta_low_ratio_before_f.Sumw2()
    JetEta_low_bx0_bxm1_before_f.Sumw2()
    JetEta_low_ratio_before_f.Divide(JetEta_low_bx0_bxm1_before_f)

    JetEta_low_ratio_before_f.SetLineColor(50)
    JetEta_low_ratio_before_f.SetMarkerColor(50)
    JetEta_low_ratio_before_f.SetMarkerStyle(8)
    JetEta_low_ratio_before_f.SetMarkerSize(0.5)
    JetEta_low_ratio_before_f.SetTitle("Before HCAL Timing Correction - FirstBunchInTrain")
    JetEta_low_ratio_before_f.GetXaxis().SetTitle("Reco Jet #eta")
    JetEta_low_ratio_before_f.GetYaxis().SetTitle("(bx=-1)/(bx=-1 or bx=0)")
    JetEta_low_ratio_before_f.SetMinimum(0)
    JetEta_low_ratio_before_f.SetMaximum(0.005)
    JetEta_low_ratio_before_f.SetStats(False)
    JetEta_low_ratio_before_f.Draw("E")

    JetEta_med_bxm1_before_f = inFile.Get("demo/JetEta_medpt_bxm1_before_firstbunch")
    JetEta_med_bx0_bxm1_before_f = inFile.Get("demo/JetEta_medpt_bx0_bxm1_before_firstbunch")

    JetEta_med_ratio_before_f = JetEta_med_bxm1_before_f.Clone()

    JetEta_med_ratio_before_f.Sumw2()
    JetEta_med_bx0_bxm1_before_f.Sumw2()
    JetEta_med_ratio_before_f.Divide(JetEta_med_bx0_bxm1_before_f)

    JetEta_med_ratio_before_f.SetLineColor(54)
    JetEta_med_ratio_before_f.SetMarkerColor(54)
    JetEta_med_ratio_before_f.SetMarkerStyle(29)
    JetEta_med_ratio_before_f.SetMarkerSize(0.5)
    JetEta_med_ratio_before_f.SetStats(False)
    JetEta_med_ratio_before_f.Draw("E same")

    JetEta_high_bxm1_before_f = inFile.Get("demo/JetEta_high_bxm1_before_firstbunch")
    JetEta_high_bx0_bxm1_before_f = inFile.Get("demo/JetEta_high_bx0_bxm1_before_firstbunch")

    JetEta_high_ratio_before_f = JetEta_high_bxm1_before_f.Clone()

    JetEta_high_ratio_before_f.Sumw2()
    JetEta_high_bx0_bxm1_before_f.Sumw2()
    JetEta_high_ratio_before_f.Divide(JetEta_high_bx0_bxm1_before_f)

    JetEta_high_ratio_before_f.SetLineColor(108)
    JetEta_high_ratio_before_f.SetMarkerColor(108)
    JetEta_high_ratio_before_f.SetMarkerStyle(21)
    JetEta_high_ratio_before_f.SetMarkerSize(0.5)
    JetEta_high_ratio_before_f.SetStats(False)
    JetEta_high_ratio_before_f.Draw("E same")

    legend = ROOT.TLegend(0.3,0.75,0.6,0.88)
    legend.AddEntry(JetEta_low_ratio_before_f,"L1 p_T > 15 GeV","L")
    legend.AddEntry(JetEta_med_ratio_before_f,"L1 p_T > 40 GeV","L")
    legend.AddEntry(JetEta_high_ratio_before_f,"L1 p_T > 180 GeV","L")
    legend.SetBorderSize(0)
    legend.SetTextSize(0.04)
    legend.Draw()

    c_eta_rat_before_f.Draw()
    c_eta_rat_before_f.SaveAs(f"{out_dir}/jeteta_ratio_ptsep_before_firstbunch.png")
    c_eta_rat_before_f.Close()

    c_eta_rat_after_f = ROOT.TCanvas( 'c_eta_rat_after_f', 'c_eta_rat_after_f', 10, 10, 800, 600 )

    JetEta_low_bxm1_after_f = inFile.Get("demo/JetEta_lowpt_bxm1_after_firstbunch")
    JetEta_low_bx0_bxm1_after_f = inFile.Get("demo/JetEta_lowpt_bx0_bxm1_after_firstbunch")

    JetEta_low_ratio_after_f = JetEta_low_bxm1_after_f.Clone()

    JetEta_low_ratio_after_f.Sumw2()
    JetEta_low_bx0_bxm1_after_f.Sumw2()
    JetEta_low_ratio_after_f.Divide(JetEta_low_bx0_bxm1_after_f)

    JetEta_low_ratio_after_f.SetLineColor(50)
    JetEta_low_ratio_after_f.SetMarkerColor(50)
    JetEta_low_ratio_after_f.SetMarkerStyle(8)
    JetEta_low_ratio_after_f.SetMarkerSize(0.5)
    JetEta_low_ratio_after_f.SetTitle("After HCAL Timing Correction - FirstBunchInTrain")
    JetEta_low_ratio_after_f.GetXaxis().SetTitle("Reco Jet #eta")
    JetEta_low_ratio_after_f.GetYaxis().SetTitle("(bx=-1)/(bx=-1 or bx=0)")
    JetEta_low_ratio_after_f.SetMinimum(0)
    JetEta_low_ratio_after_f.SetMaximum(0.005)
    JetEta_low_ratio_after_f.SetStats(False)
    JetEta_low_ratio_after_f.Draw("E")

    JetEta_med_bxm1_after_f = inFile.Get("demo/JetEta_medpt_bxm1_after_firstbunch")
    JetEta_med_bx0_bxm1_after_f = inFile.Get("demo/JetEta_medpt_bx0_bxm1_after_firstbunch")

    JetEta_med_ratio_after_f = JetEta_med_bxm1_after_f.Clone()

    JetEta_med_ratio_after_f.Sumw2()
    JetEta_med_bx0_bxm1_after_f.Sumw2()
    JetEta_med_ratio_after_f.Divide(JetEta_med_bx0_bxm1_after_f)

    JetEta_med_ratio_after_f.SetLineColor(54)
    JetEta_med_ratio_after_f.SetMarkerColor(54)
    JetEta_med_ratio_after_f.SetMarkerStyle(29)
    JetEta_med_ratio_after_f.SetMarkerSize(0.5)
    JetEta_med_ratio_after_f.SetStats(False)
    JetEta_med_ratio_after_f.Draw("E same")

    JetEta_high_bxm1_after_f = inFile.Get("demo/JetEta_high_bxm1_after_firstbunch")
    JetEta_high_bx0_bxm1_after_f = inFile.Get("demo/JetEta_high_bx0_bxm1_after_firstbunch")

    JetEta_high_ratio_after_f = JetEta_high_bxm1_after_f.Clone()

    JetEta_high_ratio_after_f.Sumw2()
    JetEta_high_bx0_bxm1_after_f.Sumw2()
    JetEta_high_ratio_after_f.Divide(JetEta_high_bx0_bxm1_after_f)

    JetEta_high_ratio_after_f.SetLineColor(108)
    JetEta_high_ratio_after_f.SetMarkerColor(108)
    JetEta_high_ratio_after_f.SetMarkerStyle(21)
    JetEta_high_ratio_after_f.SetMarkerSize(0.5)
    JetEta_high_ratio_after_f.SetStats(False)
    JetEta_high_ratio_after_f.Draw("E same")

    legend = ROOT.TLegend(0.3,0.75,0.6,0.88)
    legend.AddEntry(JetEta_low_ratio_after_f,"L1 p_T > 15 GeV","L")
    legend.AddEntry(JetEta_med_ratio_after_f,"L1 p_T > 40 GeV","L")
    legend.AddEntry(JetEta_high_ratio_after_f,"L1 p_T > 180 GeV","L")
    legend.SetBorderSize(0)
    legend.SetTextSize(0.04)
    legend.Draw()

    c_eta_rat_after_f.Draw()
    c_eta_rat_after_f.SaveAs(f"{out_dir}/jeteta_ratio_ptsep_after_firstbunch.png")
    c_eta_rat_after_f.Close()
    ...
    # RATIO
    c_etaphi_rat_before_u = ROOT.TCanvas( 'c_etaphi_rat_before_u', 'c_etaphi_rat_before_u', 10, 10, 800, 600 )

    JetEtaPhi_bxm1_before_u = inFile.Get("demo/JetEtaPhi_bxm1_before_unprefirable")
    JetEtaPhi_bx0_bxm1_before_u = inFile.Get("demo/JetEtaPhi_bx0_bxm1_before_unprefirable")
    JetEtaPhi_ratio_before_u = JetEtaPhi_bxm1_before_u.Clone()

    JetEtaPhi_ratio_before_u.Sumw2()
    JetEtaPhi_bx0_bxm1_before_u.Sumw2()
    JetEtaPhi_ratio_before_u.Divide(JetEtaPhi_bx0_bxm1_before_u)
    JetEtaPhi_ratio_before_u.SetStats(False)
    JetEtaPhi_ratio_before_u.SetTitle("(Before HCAL Timing Correction) Unprefirable (bx=-1)/(bx=0 or bx=-1)")
    JetEtaPhi_ratio_before_u.GetXaxis().SetTitle("Reco Jet #eta")
    JetEtaPhi_ratio_before_u.GetYaxis().SetTitle("Reco Jet #phi")
    JetEtaPhi_ratio_before_u.Rebin2D()
    JetEtaPhi_ratio_before_u.Draw("colz")

    c_etaphi_rat_before_u.Draw()
    c_etaphi_rat_before_u.SaveAs(f"{out_dir}/jetetaphi_ratio_before_unprefirable.png")
    c_etaphi_rat_before_u.Close() 

    c_etaphi_rat_after_u = ROOT.TCanvas( 'c_etaphi_rat_after_u', 'c_etaphi_rat_after_u', 10, 10, 800, 600 )

    JetEtaPhi_bxm1_after_u = inFile.Get("demo/JetEtaPhi_bxm1_after_unprefirable")
    JetEtaPhi_bx0_bxm1_after_u = inFile.Get("demo/JetEtaPhi_bx0_bxm1_after_unprefirable")
    JetEtaPhi_ratio_after_u = JetEtaPhi_bxm1_after_u.Clone()

    JetEtaPhi_ratio_after_u.Sumw2()
    JetEtaPhi_bx0_bxm1_after_u.Sumw2()
    JetEtaPhi_ratio_after_u.Divide(JetEtaPhi_bx0_bxm1_after_u)
    JetEtaPhi_ratio_after_u.SetStats(False)
    JetEtaPhi_ratio_after_u.SetTitle("(After HCAL Timing Correction) Unprefirable (bx=-1)/(bx=0 or bx=-1)")
    JetEtaPhi_ratio_after_u.GetXaxis().SetTitle("Reco Jet #eta")
    JetEtaPhi_ratio_after_u.GetYaxis().SetTitle("Reco Jet #phi")
    JetEtaPhi_ratio_after_u.Rebin2D()
    JetEtaPhi_ratio_after_u.Draw("colz")

    c_etaphi_rat_after_u.Draw()
    c_etaphi_rat_after_u.SaveAs(f"{out_dir}/jetetaphi_ratio_after_unprefirable.png")
    c_etaphi_rat_after_u.Close()

    c_etaphi_rat_before_f = ROOT.TCanvas( 'c_etaphi_rat_before_f', 'c_etaphi_rat_before_f', 10, 10, 800, 600 )

    JetEtaPhi_bxm1_before_f = inFile.Get("demo/JetEtaPhi_bxm1_before_firstbunch")
    JetEtaPhi_bx0_bxm1_before_f = inFile.Get("demo/JetEtaPhi_bx0_bxm1_before_firstbunch")
    JetEtaPhi_ratio_before_f = JetEtaPhi_bxm1_before_f.Clone()

    JetEtaPhi_ratio_before_f.Sumw2()
    JetEtaPhi_bx0_bxm1_before_f.Sumw2()
    JetEtaPhi_ratio_before_f.Divide(JetEtaPhi_bx0_bxm1_before_f)
    JetEtaPhi_ratio_before_f.SetStats(False)
    JetEtaPhi_ratio_before_f.SetTitle("(Before HCAL Timing Correction) FirstBunchInTrain (bx=-1)/(bx=0 or bx=-1)")
    JetEtaPhi_ratio_before_f.GetXaxis().SetTitle("Reco Jet #eta")
    JetEtaPhi_ratio_before_f.GetYaxis().SetTitle("Reco Jet #phi")
    JetEtaPhi_ratio_before_f.Rebin2D()
    JetEtaPhi_ratio_before_f.Draw("colz")

    c_etaphi_rat_before_f.Draw()
    c_etaphi_rat_before_f.SaveAs(f"{out_dir}/jetetaphi_ratio_before_firstbunch.png")
    c_etaphi_rat_before_f.Close()

    c_etaphi_rat_after_f = ROOT.TCanvas( 'c_etaphi_rat_after_f', 'c_etaphi_rat_after_f', 10, 10, 800, 600 )

    JetEtaPhi_bxm1_after_f = inFile.Get("demo/JetEtaPhi_bxm1_after_firstbunch")
    JetEtaPhi_bx0_bxm1_after_f = inFile.Get("demo/JetEtaPhi_bx0_bxm1_after_firstbunch")
    JetEtaPhi_ratio_after_f = JetEtaPhi_bxm1_after_f.Clone()

    JetEtaPhi_ratio_after_f.Sumw2()
    JetEtaPhi_bx0_bxm1_after_f.Sumw2()
    JetEtaPhi_ratio_after_f.Divide(JetEtaPhi_bx0_bxm1_after_f)
    JetEtaPhi_ratio_after_f.SetStats(False)
    JetEtaPhi_ratio_after_f.SetTitle("(After HCAL Timing Correction) FirstBunchInTrain (bx=-1)/(bx=0 or bx=-1)")
    JetEtaPhi_ratio_after_f.GetXaxis().SetTitle("Reco Jet #eta")
    JetEtaPhi_ratio_after_f.GetYaxis().SetTitle("Reco Jet #phi")
    JetEtaPhi_ratio_after_f.Rebin2D()
    JetEtaPhi_ratio_after_f.Draw("colz")

    c_etaphi_rat_after_f.Draw()
    c_etaphi_rat_after_f.SaveAs(f"{out_dir}/jetetaphi_ratio_after_firstbunch.png")
    c_etaphi_rat_after_f.Close()
